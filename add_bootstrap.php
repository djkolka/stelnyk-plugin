...
function add_bootstrap(){
  ...
  <input type="radio" name="option_name[bootstrap_version]" id="bootstrap_version" value="452"<?php if ($val == 452)echo 'checked="checked"';?>>Version-4.5.2<br>
...
if ($val == 452) {
  // *** add bootstrap-4.5.2 ***
  function register_style_and_scripts_bootstrap_452() {
      // false - header, true - footer
      wp_enqueue_style( 'bootstrap_452_css', plugin_dir_url( __FILE__ ) . 'bootstrap/bootstrap-4.5.2-dist/css/bootstrap.min.css' );
      wp_enqueue_script( 'bootstrap_452_js', plugin_dir_url( __FILE__ ) . 'bootstrap/bootstrap-4.5.2-dist/js/bootstrap.min.js', null, null, false );
      wp_enqueue_style('font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css');
  }
  add_action( 'wp_enqueue_scripts', 'register_style_and_scripts_bootstrap_452' );
  // END *** add bootstrap-4.5.2 ***
} 
else if ($val == 4) {
  // *** add bootstrap-4.3.1 ***
